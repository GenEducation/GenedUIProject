...
export default function PartnerMe() {
  ...
  const displayName = profile?.name ?? profile?.username ?? "Partner";
    ...
    <Screen background={colors.pageBg}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.role}>Institution Partner</Text>
...
const styles = StyleSheet.create({
  ...
  role:  { fontFamily: fonts.dmBold, fontSize: 13, color: colors.edGreen, marginTop: 4 },
