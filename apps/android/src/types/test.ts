/**
 * Test runner types — mirrors the web's src/features/student/types/test.ts,
 * which is the real backend contract for /create-chapter-test, /tests/{id},
 * and /tests/{id}/submit. (The legacy shapes in api.ts are oversimplified and
 * only used by the Practice list / Report card.)
 */

export type ZPDVerdict = "ABOVE" | "AT" | "BELOW";
export type ScaffoldingTier =
  | "Heavy Scaffolding"
...
/** Grouped section for the runner's one-section-per-screen UX. */
