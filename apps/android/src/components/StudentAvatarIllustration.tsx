/**
 * Student profile avatar illustration, ported from the web app's
 * StudentAvatarIllustration (src/features/student/components). The backdrop
 * circle color is a prop so it can be re-themed by the color picker; the
 * viewBox is cropped to that circle (center 332,318 r=300) so a circular
 * container clips it exactly.
 */
...
export function StudentAvatarIllustration({ bg }: StudentAvatarIllustrationProps) {
  return (
    <Svg viewBox="32 18 600 600" fill="none" width="100%" height="100%">
      <Circle cx="332" cy="318" r="300" fill={bg} />
