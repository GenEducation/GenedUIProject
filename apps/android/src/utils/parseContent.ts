...
<svg width="400" height="200" viewBox="0 0 400 200" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="200" y="105" text-anchor="middle" fill="#1A6BBF" fill-opacity="0.3" font-family="System" font-size="12" font-weight="bold" style="text-transform: uppercase; letter-spacing: 0.1em;">Learning Blueprint</text>
  <text x="200" y="125" text-anchor="middle" fill="#1A6BBF" fill-opacity="0.2" font-family="System" font-size="10">Visualization Ready</text>
</svg>
`;
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  ${shapeMarkup}
  ${params.label ? `<rect x="${width/2-60}" y="${height-35}" width="120" height="20" rx="10" fill="${textDark}" fill-opacity="0.03" /><text x="${width/2}" y="${height-21}" text-anchor="middle" fill="${textDark}" fill-opacity="0.4" font-family="System" font-size="10" font-weight="800" style="text-transform: uppercase; letter-spacing: 0.15em;">${params.label}</text>` : ""}
</svg>`;
}
