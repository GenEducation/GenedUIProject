...
export function SignUp({
  ...
  if (!isSignupEnabled) {
    return (
      <div className="rounded-[2.5rem] border border-[#2D5540]/10 bg-[#F9F8F4] p-8 sm:p-10 shadow-xl shadow-[#0E1F2B]/5 text-center py-20 flex flex-col items-center justify-center">
        <div className="w-20 h-20 bg-[#042e5c]/5 rounded-full flex items-center justify-center mb-6 animate-pulse">
           <svg className="w-10 h-10 text-[#042e5c]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
           </svg>
        </div>
        <h3 className="text-xl font-extrabold text-[#042e5c] mb-4">Registration Restricted</h3>
        <p className="text-[#2D3E51]/70 text-sm font-medium leading-relaxed max-w-xs mb-10">
          This page is not for public access currently, please contact us at {" "}
          <a href="mailto:support@geneducation.ai" className="text-[#042e5c] font-bold hover:underline">
        ...
        <button
          ...
          className="group flex items-center justify-center gap-2 px-8 py-3.5 rounded-2xl bg-white border border-[#2D5540]/15 text-[#042e5c] text-sm font-bold shadow-sm transition-all hover:bg-[#F9F8F4] hover:border-[#2D5540]/30 active:scale-[0.98]"
        >
