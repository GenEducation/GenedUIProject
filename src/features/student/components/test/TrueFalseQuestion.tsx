  ...
  return (
    <div className="space-y-4">
      ...
      {question.justification_required && selectedAnswer && (
        ...
        >
          <label className="block text-[13px] font-semibold text-[var(--primary-ink)]/60 uppercase tracking-wider mb-2">
            Explain your answer
          </label>
          <textarea
            value={justification}
            ...
            rows={3}
            className="w-full p-3 sm:p-4 rounded-xl border-2 border-[var(--primary-ink)]/10 focus:border-[var(--primary-ink)]/30 focus:ring-4 focus:ring-[var(--primary-ink)]/5 outline-none transition-all text-[15px] resize-none"
          />
        </motion.div>
      )}
    </div>
