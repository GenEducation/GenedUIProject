 ...
 * chains — some read `name || username`, the chat sidebar read `username`
 * only — which is why the same child showed up as "utkarsh" in one place and
 * "utkrshsharma141" in another. Route every surface through this instead.
 */
